"""
Please note if you're reading this file - we ran our tests on a corpus of popular Github repositories,
and this is one from a popular repository named "thefuck" https://github.com/nvbn/thefuck,
that caused an error in testing, so I wanted to include it in our test suite - it's not an attempt to be arbitrarily crass.
"""
# -*- encoding: utf-8 -*-
